...
$idVendedor=htmlspecialchars($_GET['id']);


$productos = $productosDAO->getByUsuario($idVendedor);
...
<header>
  ...
  <div id="separacion">
    ...
    <?php foreach ($productos as $producto): ?>
        ...
        <div class="product">
            <a href="vistas/productoEditar.php?id=<?= $producto->getId() ?>">
            <img src="./fotoProductos/<?= $producto->getFoto()?>" id="fotoProducto" alt="Producto 1">
