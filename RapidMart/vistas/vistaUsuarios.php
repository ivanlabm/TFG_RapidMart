...
foreach ($usuarios as $usuario){
    switch ($usuario->getRol()) {
        case (str_contains($usuario->getRol(), 'admin')):
            $admins[] = $usuario;
            break;
        case (str_contains($usuario->getRol(), 'Vendedor')):
                $vendedores[] = $usuario;
                break;
        case (str_contains($usuario->getRol(), 'Cliente')):  
            $losusuarios[] = $usuario;
            break;
  ...
  <div id="separacion">
    ...
    <table>
        ...
        <?php foreach ($admins as $admin): ?>
            <tr>
                <td><img src="fotoUsuario/<?= $admin->getFoto()?>"></td>
                <td><?= $admin->getId()?></td>
                <td><?= $admin->getNombre()?></td>
                <td><?= $admin->getApellidos()?></td>
                <td><a href="vistas/usuarioEditar.php?id=<?= $admin->getId()?>"><?= $admin->getCorreo()?></a></td>
            </tr>
            <?php  endforeach; ?>
        </tbody>
    </table>
    ...
    <table>
        ...
        <?php foreach ($vendedores as $vendedor): ?>
            <tr>
                <td><img src="fotoUsuario/<?= $vendedor->getFoto()?>"></td>
                <td><?= $vendedor->getId()?></td>
                <td><?= $vendedor->getNombre()?></td>
                <td><?= $vendedor->getApellidos()?></td>
                <td><a href="vistas/usuarioEditar.php?id=<?= $vendedor->getId()?>"><?= $vendedor->getCorreo()?></a></td>
                <td>
                    <a href="map.php?accion=misProductos&id=<?= $vendedor->getId()?>">
                    <?php 
                        $productos=$productosDAO->getByUsuario($vendedor->getId());
                        $cont=0;
    ...
    <table>
        ...
        <?php foreach ($losusuarios as $elusuario): ?>
            <tr>
                <td><img src="fotoUsuario/<?= $elusuario->getFoto()?>"></td>
                <td><?= $elusuario->getId()?></td>
                <td><?= $elusuario->getNombre()?></td>
                <td><?= $elusuario->getApellidos()?></td>
                <td><a href="vistas/usuarioEditar.php?id=<?= $elusuario->getId()?>"><?= $elusuario->getCorreo()?></a></td>
            </tr>
            <?php  endforeach; ?>
        </tbody>
    </table>
