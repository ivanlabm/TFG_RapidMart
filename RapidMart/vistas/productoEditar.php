...
<header>
  ...
  <form action="../map.php?accion=editar&id=<?= $idProducto ?>" method="POST">
    <div class="main-content">
      <div class="top-section">
        ...
        <div class="right-column">
          <div class="product-name">
            <input type="text" id="pp-nombre" name="nombre" value="<?= $producto->getNombre() ?>" style="border: none; background-color: transparent;width: 100%; font-size: 1.5em; font-weight: bold;">
            <input type="text" id="pp-precio" name="precio" value="<?= $producto->getPrecio() ?>" style="border: none; background-color: transparent;width: 100%; font-size: 1.5em; font-weight: bold;">
          </div>
          <div class="product-description">
            <input type="text" id="pp-descripcion" name="descripcion" value="<?= $producto->getDescripcion() ?>" style="border: none; background-color: transparent; width: 100%;">
            <input type="text" id="pp-stock" name="stock" value="<?= $producto->getStock() ?>" style="border: none; background-color: transparent; width: 100%;">
          </div>
      ...
      <div class="product-specs">
        ...
        <input type="text" id="pp-especificaciones" name="especificaciones" value="<?= $producto->getEspecificaciones() ?>" style="border: none; background-color: transparent; width: 100%;">
